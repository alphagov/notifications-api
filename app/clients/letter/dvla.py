...
class DVLAClient:
    ...
    def send_letter(
        ...
        *,
        ...
        upload_file_response = self.session.put(upload_url, headers={"Content-Type": "application/pdf"}, data=pdf_file)
        current_app.logger.info("Status code when uploading the file : %s", upload_file_response.status_code)
