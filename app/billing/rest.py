...
def update_free_sms_fragment_limit_data(service_id, free_sms_fragment_limit):
    ...
    if default_free_allowance == free_sms_fragment_limit:
        has_custom_free_allowance = False
    else:
        has_custom_free_allowance = True

    dao_create_or_update_annual_billing_for_year(
        service_id,
        free_sms_fragment_limit,
        current_year,
        has_custom_allowance=has_custom_free_allowance,
    )
