...
def create_fake_letter_response_file(self, reference):
    ...
    # try and find a filename that has not been taken yet - from a random time within the last 30 seconds
    ...
    # on development we cannot trigger SNS callbacks so we need to manually hit the DVLA callback endpoint
