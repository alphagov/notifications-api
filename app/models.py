...
class Service(db.Model, Versioned):
    ...
    letter_message_limit = db.Column(db.BigInteger, index=False, unique=False, nullable=False, default=20_000)
    sms_message_limit = db.Column(db.BigInteger, index=False, unique=False, nullable=False, default=250_000)
    email_message_limit = db.Column(db.BigInteger, index=False, unique=False, nullable=False, default=250_000)
