...
class Service(db.Model, Versioned):
    ...
    letter_message_limit = db.Column(db.BigInteger, index=False, unique=False, nullable=True, default=999_999_999)
    sms_message_limit = db.Column(db.BigInteger, index=False, unique=False, nullable=True, default=999_999_999)
    email_message_limit = db.Column(db.BigInteger, index=False, unique=False, nullable=True, default=999_999_999)
