...
def get_sms_fragments_sent_last_financial_year(service_id: str) -> int:
    """
    select coalesce(sum(billable_units * rate_multiplier), 0) as units_used from ft_billing
    where service_id = 'af90d4cb-ae88-4a7c-a197-5c30c7db423b'
    and notification_type = 'sms'
    and bst_date >= '2016-04-01'
    and bst_date < '2017-04-01';
