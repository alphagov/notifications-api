...
def dao_fetch_service_guest_list(service_id):
    return ServiceGuestList.query.filter(ServiceGuestList.service_id == service_id).all()
...
def dao_remove_service_guest_list(service_id):
    return ServiceGuestList.query.filter(ServiceGuestList.service_id == service_id).delete()
