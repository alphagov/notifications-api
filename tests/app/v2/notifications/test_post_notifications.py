...
@pytest.mark.parametrize(
    'personalisation, expected_status',
    (
        ({"doc": 'just some text'}, 201),
        ({"doc": {"file": False}}, 400),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK"}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "is_csv": None}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "is_csv": True}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "is_csv": False}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "is_csv": True, "confirm_email_before_download": None}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "is_csv": True, "confirm_email_before_download": True}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "is_csv": True, "confirm_email_before_download": False}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "is_csv": True, "confirm_email_before_download": 'potato'}}, 400),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "retention_period": None}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "retention_period": "1 week"}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "retention_period": "70 weeks"}}, 201),

        # String content (number of weeks, anything non-weeks) is validated downstream document-download-api
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "retention_period": "9999 weeks"}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "retention_period": "1 month"}}, 201),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "retention_period": False}}, 400),
        ({"doc": {"file": "YSxiLGMKMSwyLDMK", "other": "attribute"}}, 400),
        ({"doc": {"potato": "YSxiLGMKMSwyLDMK"}}, 201),
        ({"doc": {"potato": "YSxiLGMKMSwyLDMK", "is_csv": "cucumber"}}, 201),
    )
)
def test_post_email_notification_validates_personalisation_dict_values(
    api_client_request,
    mocker,
    personalisation,
    expected_status
    ...
    service = create_service(
        ...
        service_permissions=[EMAIL_TYPE, DOCUMENT_DOWNLOAD_VERIFY_EMAIL],
    )
