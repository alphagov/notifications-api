...
@pytest.mark.parametrize("number_of_files", [0, 1, 4])
def test_save_email_with_template_email_files_increaments_document_download_count_correctly(
    mock_celery_task,
    ...
    assert notification.document_download_count == number_of_files
