...
from app.dao.inbound_numbers_dao import (
    archive_or_release_inbound_number,
...
def test_archive_or_release_inbound_number(sample_service, sample_inbound_numbers, sample_inbound_sms_history):
    inbound = next((inbound for inbound in sample_inbound_numbers if inbound.service_id == sample_service.id), None)

    archive_or_release_inbound_number(sample_service.id, inbound.number)
