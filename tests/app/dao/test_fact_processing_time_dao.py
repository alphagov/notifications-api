...
def test_get_processing_time_percentage_for_date_range(notify_db_session):
    create_process_time(bst_date="2021-02-21", messages_total=5, messages_within_10_secs=4)
    create_process_time(bst_date="2021-02-22", messages_total=3, messages_within_10_secs=2)
    create_process_time(bst_date="2021-02-23", messages_total=4, messages_within_10_secs=3)
...
def test_get_processing_time_percentage_for_date_range_handles_zero_cases(notify_db_session):
    create_process_time(bst_date="2021-02-21", messages_total=0, messages_within_10_secs=0)
    create_process_time(bst_date="2021-02-22", messages_total=10, messages_within_10_secs=0)
