...
def test_dao_get_oldest_ongoing_report_request_returns_true_for_recent_matching_notification_request(
    ...
    result = dao_get_oldest_ongoing_report_request(report_request, timeout=report_request_notification_timeout)
...
def test_dao_get_oldest_ongoing_report_request_returns_false_for_stale_created_at_when_updated_at_is_none(
    sample_service, sample_user
):
    param = {"notification_type": "sms", "notification_status": "sending"}
...
def test_dao_get_oldest_ongoing_report_request_returns_false_when_no_match_notification_request(
    sample_service, sample_user
):
    ...
    result = dao_get_oldest_ongoing_report_request(lookup_request, timeout=report_request_notification_timeout)
    assert result is None
...
def test_dao_get_oldest_ongoing_report_request_returns_true_when_updated_at_is_none_and_created_at_recent(
    ...
    result = dao_get_oldest_ongoing_report_request(report_request, timeout=timeout)
...
def test_dao_get_oldest_ongoing_report_request_returns_false_if_user_id_different(
    ...
    timeout = current_app.config.get("REPORT_REQUEST_NOTIFICATIONS_TIMEOUT_MINUTES")
    assert dao_get_oldest_ongoing_report_request(lookup, timeout=timeout) is None
...
def test_dao_get_oldest_ongoing_report_request_returns_oldest_when_multiple_matches_exist(sample_service, sample_user):
    ...
    timeout = current_app.config.get("REPORT_REQUEST_NOTIFICATIONS_TIMEOUT_MINUTES")
    result = dao_get_oldest_ongoing_report_request(older_request, timeout=timeout)
