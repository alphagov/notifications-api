...
def test_find_organisations_by_name_finds_organisations(notify_db_session, admin_request):
...
def test_find_organisations_by_name_handles_no_results(notify_db_session, admin_request):
    create_organisation(name="ABCDEF")
    response = admin_request.get("organisation.search", name="1234")
    assert response["data"] == []


def test_find_organisations_by_name_handles_special_characters(notify_db_session, admin_request):
    create_organisation(name="ABCDEF")
...
def test_find_organisations_by_name_handles_no_organisation_name(notify_db_session, admin_request):
