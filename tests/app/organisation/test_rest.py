...
@pytest.mark.parametrize("org_type", ["nhs_central", "nhs_local", "nhs_gp", "private_pharmacy"])
...
@pytest.mark.parametrize("new_org_type", ["nhs_central", "nhs_local", "nhs_gp", "private_pharmacy"])
