...
def upgrade():
    ...
    op.create_index(
        op.f("ix_stats_template_usage_by_month_month"), "stats_template_usage_by_month", ["month"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_stats_template_usage_by_month_year"), "stats_template_usage_by_month", ["year"], unique=False
    )
