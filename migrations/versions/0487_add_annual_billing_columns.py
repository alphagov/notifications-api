...
def upgrade():
    op.add_column("annual_billing", sa.Column("high_volume_service_last_year", sa.Boolean(), nullable=True))
    op.add_column("annual_billing", sa.Column("has_custom_allowance", sa.Boolean(), nullable=True))
