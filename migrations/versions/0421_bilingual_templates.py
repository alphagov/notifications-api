...
def upgrade():
    ...
    op.add_column(
        "templates", sa.Column("letter_languages", letter_language_options, nullable=False, server_default="english")
    )
    ...
    op.add_column(
        "templates_history",
        sa.Column("letter_languages", letter_language_options, nullable=False, server_default="english"),
    )
