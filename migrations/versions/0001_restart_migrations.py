...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column(
            "status", sa.Enum("pending", "accepted", "cancelled", name="invited_users_status_types"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_notification_statistics_service_id"), "notification_statistics", ["service_id"], unique=False
    )
    op.create_table(
        "permissions",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "in progress", "finished", "sending limits exceeded", name="job_status_types"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.Column(
            "status", sa.Enum("sending", "delivered", "failed", name="notification_status_types"), nullable=False
        ),
