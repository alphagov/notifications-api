...
def upgrade():
    ...
    op.create_index(
        op.f("ix_service_callback_api_history_service_id"), "service_callback_api_history", ["service_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_service_callback_api_updated_by_id"), "service_callback_api", ["updated_by_id"], unique=False
    )
