...
def upgrade():
    ...
    op.create_table(
        "service_callback_type", sa.Column("name", sa.String(), nullable=False), sa.PrimaryKeyConstraint("name")
    )
    ...
    op.create_foreign_key(
        "service_callback_api_type_fk", "service_callback_api", "service_callback_type", ["callback_type"], ["name"]
    )
