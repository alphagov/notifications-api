...
def upgrade():
    ...
    op.create_index(
        op.f("ix_provider_details_history_created_by_id"), "provider_details_history", ["created_by_id"], unique=False
    )
    op.create_foreign_key(
        "provider_details_history_created_by_id_fkey", "provider_details_history", "users", ["created_by_id"], ["id"]
    )
